...
def download_using_coroutine(urls):
    ...
    spawns = []
    for url in urls:
        spawns.append(gevent.spawn(requests.get,url))
...
def main():
    ...
    # 输出：
    '''
    [finished function:download_using_single_thread in 6.25s]
    '''
    ...
    # 输出：
    '''
    [finished function:download_using_coroutine in 0.75s]
    '''
    ...
    # 输出：
    '''
    [finished function:download_using_coroutine_pool in 0.77s]
    '''
